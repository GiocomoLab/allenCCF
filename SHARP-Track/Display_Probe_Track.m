...
for selected_probe = probes
    ...
    %EAJ added 18/2/21 to store channel ranges
    borders_table.upperChannel = (probe_length*100-int64(borders_table.upperBorder/shrinkage_factor))/10;
    borders_table.lowerChannel = (probe_length*100-int64(borders_table.lowerBorder/shrinkage_factor))/10;
